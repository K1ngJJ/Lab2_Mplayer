    ...
    public function delete_playlist($id)
{
    ...
    $playlistModel = new \App\Models\PlModel();
    ...
    public function add_playlist()
{
    ...
    return view('CreatePlaylist', $data);
    ...
    public function index()
    {
        ...
        $musicModel = new \App\Models\McModel();
    ...
    public function upload()
{
    ...
    public function play($id)
    {
        ...
        if ($music) {
            ...
            return view('play', ['music_to_play' => $music, 'music_path' => $musicPath]);
        } else {
            // Music not found
            return redirect()->to('music');
        }
    ...
    {
        // Fetch the music record with the given ID from the database
        $musicModel = new \App\Models\McModel(); // Replace with your actual model class name
        $music = $musicModel->find($id);

        if ($music) {
            // Load the view to confirm the music deletion
            return view('remove', ['music_to_delete' => $music]);
        } else {
