    ...
    <div class="mb-4">
        <form action="<?= site_url('music/add_playlist') ?>" method="post">
            ...
            <div class="container mt-2">
                  <div class="mb-1">
            <button type="submit" class="btn btn-success" style="background-color: #319177">Create Playlist</button>
              <span><a class="btn btn-primary" href="/music" style="background-color: #0892d0">Back</a></span>
          </div>
        </div>
        </form>
    </div>
